...
int *soundTune_3[6] = {low4, hSpike, low4, hSpike, low4, hSpike};
int soundIntervals_3[6] = {12000, 12000,  12000, 12000, 12000, 20000};
int soundDurations_3[6] = {500000, 500000, 500000, 500000, 500000, 500000};
...
// soundTune_5
int *soundTune_5[4] = {cosine, cosine, cosine, cosine};
int soundIntervals_5[4] = {10000, 10000, 10000, 10000};
int soundDurations_5[4] = {3000000, 3000000, 3000000, 3000000};

// soundTune_6
int *soundTune_6[4] = {cosine, cosine, cosine, cosine};
int soundIntervals_6[4] = {20000, 20000, 20000, 20000};
...
void play(size_t melody)
{
	...
	{
		playSound(soundTune_3, 6, 4, soundIntervals_3, soundDurations_3);
	}
	else if (melody == 4)
	{
	...
	{
		playSound(soundTune_5, 4, 16, soundIntervals_5, soundDurations_5);
